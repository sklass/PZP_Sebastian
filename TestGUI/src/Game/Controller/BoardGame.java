package Game.Controller;//Grundgerüst für Game.Controller.TicTacToe und 4Gewinnt von denen beide abgeleitet werden
...
abstract public class BoardGame {
    ...
    protected Game.Model.Board Board;
    protected UserInterface Console;

    //zwingt die instanzen der Klasse Game.Controller.BoardGame die folgenden Methoden zu definierenk
    abstract public void GameStateHandler();
    abstract public void makeAMove();
    abstract public void checkDiagonale();
    ...
    protected void showBoard() { //Methode die die Methode zum anzeigen des Spielfelds auruft
        int cols = this.Board.getCols();      //Game.Model.Board größe, koordinaten der vorhandenen Spielsteine und header ermitteln
