...
public class FourWins extends BoardGame { //Klasse Game.Controller.FourWins wird von der abstrakten klasse Game.Controller.BoardGame abgeleitet
        ...
        while(GameStatus <=10){
            switch(GameStatus){
                case 0: // Vor dem Spiel die Regeln und bedienung erklären
                    this.Console.print("Welcome to Game.Controller.FourWins v1.1");
    ...
    public void makeAMove(){
        ...
        //SetCoordinates speichert die neuen Daten im Game.Model.Board objekt
    }

    //Abfrage einer Spalte mithilfe des Game.View.UserInterface
    ...
    public void checkDiagonale(){
        int rows = this.Board.getRows();
        //int cols = this.Game.Model.Board.getCols();
        int[][] coordinates = this.Board.getCoordinates();
        int Points;
