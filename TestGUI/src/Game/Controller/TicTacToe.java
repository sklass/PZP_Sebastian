...
public class TicTacToe extends BoardGame {
        ...
        while(GameStatus <=10){
            switch(GameStatus){
                case 0: // Vor dem Spiel die Regeln und bedienung erklären
                    this.Console.print("Welcome to Game.Controller.TicTacToe v1.1");
    ...
    public void makeAMove(){
        ...
        this.Board.setCoordinates(coordinates); //Das aktuelle Koordinaten array wird ans Game.Model.Board zurückgegeben
    }
